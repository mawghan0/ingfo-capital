    ...
    <>
      <div className="h-full flex flex-col">
        ...
        <p className="sm:text-lg md:text-xl text-darkText p-4 text-center font-body mb-1 xl:px-32">
          Ingfo Capital is a Decentralized Autonomous Organization (DAO) that
          has been established since 2021. Initially, we only consisted of seven
        ...
        <div className="sm:bottom-5 md:bottom-7 lg:bottom-10 flex-col flex px-5 py-3 border border-highlight font-sans items-center absolute bottom-1 w-full lg:w-10/12 self-center">
          <a
          ...
          <a href="https://t.co/Fxb3QoNHuh">
            <div className="text-highlight text-lg font-bold flex hover:text-rose-200 group">
              ...
              <svg
                ...
                height="2em"
                viewBox="0 2 22 22"
                className=" text-highlight group-hover:text-rose-200"
              >
                <path
                  fill="currentColor"
